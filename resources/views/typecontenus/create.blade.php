        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ajouter un Nouveau Type de Contenu</h3>
                    ...
                    <form action="{{ route('typecontenus.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nom_contenu') is-invalid @enderror" 
                                   id="nom_contenu" name="nom_contenu" value="{{ old('nom_contenu') }}" required
                                   placeholder="ex: Article, Actualité, Document...">
                            @error('nom_contenu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted">
                                Définir un type de contenu pour catégoriser les publications
                            </small>
                        </div>

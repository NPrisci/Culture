...
<html lang="en">
  ...
  <head>
    ...
    <title>BéninCulture| Dashboard</title>
    ...
    <link rel="preload" href="{{URL::asset('admin/css/adminlte.css')}}"  as="style" />
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootsrap.min.css">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="dropdown">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="{{ URL::asset('admin/assets/img/AdminLTELogo.png') }}"
              alt="AdminLTE Logo"
              class="brand-image opacity-75 shadow"
            />
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Bénin Culture</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
      ...
      <footer class="app-footer">
        ...
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="" class="text-decoration-none">Plateforme Culture & Langues du Bénin</a>.

...
@section('title', 'Ajouter une Relation Région-Langue')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ajouter une Nouvelle Relation Région-Langue</h3>
                    ...
                    <form action="{{ route('parler.store') }}" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Créer la relation
                            </button>
                        </div>
                    </form>
                </div>
